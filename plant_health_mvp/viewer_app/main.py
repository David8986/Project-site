...
class ViewerWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, initial_input: str = "", initial_wavelengths: str = "", initial_output: str = "") -> None:
        ...
        self.output_path.setText(initial_output or str(Path("plant_health_mvp") / "runs" / "viewer_export"))
    ...
    def _export_preview(self) -> None:
        if self.current_display is None:
            return
        output = Path(self.output_path.text().strip() or "plant_health_mvp/runs/viewer_export")
...
def launch(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default=str(Path("plant_health_mvp") / "runs" / "viewer_export"))
