...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(
        ...
        self.output_path.setText(initial_output or str(Path("plant_health_mvp") / "runs" / "gui_export"))
    ...
    def _save_path(self, title: str, filter_text: str, default_suffix: str) -> Path | None:
        start = self.output_path.text().strip() or str(Path("plant_health_mvp") / "runs" / "gui_export")
...
def launch_gui(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output", default=str(Path("plant_health_mvp") / "runs" / "gui_export"))
